...
def addorder():
    print("\033[0;35;m-------------------------------------------------------------------居家智享支装订单正常流程运行开始-------------------------------------------------------------------\033[0m")
    ...
    print("收件人姓名：yi支装测试" + str(i.month) + str(i.day))
    ...
    data1 = {
                ...
                "allPackages": "4",
                "allCargoPrice": "245",
                "consigneeName": "yi支装测试" + str(i.month) + str(i.day),
...
def normalflow(db,db1):
    i = datetime.datetime.now()
    consignee_name1 = "yi支装测试" + str(i.month) + str(i.day)
    ...
    try:
        ...
        print("\033[0;35;m-------------------------------------------------------------------居家智享支装订单正常流程测试结束-------------------------------------------------------------------\033[0m")
