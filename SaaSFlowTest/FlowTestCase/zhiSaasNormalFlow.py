...
def addorder():
    print("\033[0;35;m-------------------------------------------------------------------居家智享支订单正常流程运行开始-------------------------------------------------------------------\033[0m")
    ...
    print("收件人姓名：yi支测试" + str(i.month) + str(i.day))
    ...
    data1 = {
                ...
                "allPackages": "4",
                "allCargoPrice": "123",
                "consigneeName": "yi支测试" + str(i.month) + str(i.day),
                "consigneePhone": "15023621702",
                "consigneeAddress": "武侯区",
                "floor": "4",
                "deliveryName": "提货联系:提货联系:",
                ...
                "districtNo": "510107",
                "district": "武侯区",
                "deliveryProvinceNo": "510000",
                "deliveryProvince": "四川省",
                "deliveryCityNo": "510100",
                "deliveryCity": "成都市",
                "deliveryDistrictNo": "510107",
                "deliveryDistrict": "武侯区",
                "verifyOrderNo": ""
}
...
def normalflow(db,db1):
    i = datetime.datetime.now()
    consignee_name1 = "yi支测试" + str(i.month) + str(i.day)
    ...
    try:
        ...
        print("\033[0;32;m**************************************************居家小二操作提货**************************************************\033[0m")
        db1.connect()
        ...
        print("\033[0;35;m-------------------------------------------------------------------居家智享支订单正常流程测试结束-------------------------------------------------------------------\033[0m")
