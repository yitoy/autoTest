...
class TestMethod(unittest.TestCase):    # 定义一个类，继承自unittest.TestCase
    ...
    def test_a(self):
        ...
        print("收件人姓名：yi配装测试" + str(i.month) + str(i.day))
        data1 = {
                "businessNo": "BSTE02",
                "serviceNo": "FHB01",
                "orderWay": 1,
                ...
                "goods": [
                    {
                        "num": 1,
		                "picture": "5b9767715b1fac00019759ad",
                        "memo": "",
                        "bigClassNo": "FHB08",
                        "middleClassNo": "FHB08072",
                        "pictureType": "2",
                        "pictureName": "信号花架"
                    }
                ],
                ...
                "allPackages": "3",
                "allCargoPrice": "1212",
                "consigneeName": "yi配装测试" + str(i.month) + str(i.day),
    ...
    def test_b(self):
        ...
        global i
        i = datetime.datetime.now()
        consignee_name1 = "yi配装测试" + str(i.month) + str(i.day)
        # 使用cursor()方法获取操作游标
